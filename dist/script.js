...
/* harmony import */ var _modules_froms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/froms */ "./src/js/modules/froms.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  showUpSlider.init();
  var moduleSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  new _modules_froms__WEBPACK_IMPORTED_MODULE_4__["default"]('.form').init();
});
...
function () {
  function Difference(oldOfficer, newOfficer, items) {
    ...
    this.oldItems = this.oldOfficer.querySelectorAll(items); //? елементи в середині кожного стовбця
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          if (document.querySelector('iframe#frame')) {
            //! визначаємо чи вже викликано плеєр і якщо так, то ми лише активовуємо плеєр без його генерації
            _this.overlay.style.display = 'flex';
          } else {
            //! якщо плеєр генерується вперше, то викликаємо код нижче
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      this.slides[this.slideIndex - 1].style.display = 'block'; //! візуалізація поточного блока
    } //! контроль пересування слайдів в будь-яку сторону
    ...
    value: function render() {
      ...
      //? так як даний блок може і не об'явитись при використанні на інших частинах сторінки, ми беремо його в дану конструкцю, щоб скрирпт міг працювати і без цього
      try {
      ...
      this.btns.forEach(function (item) {
        item.addEventListener('click', function () {
          _this2.plusSlide(1);
        }); //! клік на логотип переводить нас на першу сторінку
...
//! один великий прототип для усіх слайдерів в проекті
